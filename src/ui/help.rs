...
fn get_entries() -> Vec<(String, String)> {
    vec![
        ...
        (t("help.filters"), String::new()),
        ("  time<N".to_string(), t("help.filter_time_active")),
        ("  time>N".to_string(), t("help.filter_time_stale")),
        ("  age>=N".to_string(), t("help.filter_age")),
        ("  units".to_string(), t("help.filter_units")),
        (t("help.actions"), String::new()),
        ("  x".to_string(), t("help.kill_session")),
        ("  X".to_string(), t("help.kill_orphans")),
        ("  r".to_string(), t("help.refresh")),
        ("  R".to_string(), t("help.reset_view")),
